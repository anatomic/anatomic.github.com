...
/***/ function(module, exports, __webpack_require__) {
	...
	reqwest({
	    ...
	    posts = resp.posts;
	    React.renderComponent(Blog({ posts: posts, currentPost: path }), document.getElementById('content'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: 'exports',
	    getCurrentPost: function() {
	        var postData;
	        this.props.posts.some(function(post) {
	            if (this.props.currentPost === post.path) {
	                postData = post;
	                return true;
	            }
	        }, this);
	    ...
	    getInitialState: function() {
	        ...
	        return {
	            ...
	            postPublishedAt: currentPost.publishedAtHuman,
