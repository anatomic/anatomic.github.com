...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    reqwest = __webpack_require__(2),
	    Blog = __webpack_require__(3);

	var SITEMAP = '/sitemap.json';
	var path = 'posts/' + window.location.pathname.slice(1,-1).split('/').join('-') + '.html';
	...
	reqwest({
	    ...
	    siteData = resp;
	    var initialPost;
	    siteData.posts.some(function(post) {
	        if (path === post.path) {
	            initialPost = post;
	            return true;
	        }
	    ...
	    reqwest({
	        ...
	        React.renderComponent(Blog({
	            initialTitle: post.title,
	            initialPublishedAt: post.publishedAtHuman,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ...
	    Navigation = __webpack_require__(6);
	...
	module.exports = React.createClass({displayName: 'exports',
	    ...
	    getInitialState: function() {
	        return {
	            postTitle: this.props.initialTitle,
	            postContent: this.props.initialContent,
	            postPublishedAt: this.props.initialPublishedAt
	        };
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	hljs.registerLanguage('vim', __webpack_require__(90));
	hljs.registerLanguage('xml', __webpack_require__(91));
	hljs.registerLanguage('css', __webpack_require__(92));
	hljs.registerLanguage('scss', __webpack_require__(93));
	        ...
	        return (
	            React.DOM.div({className: "article"}, 
	                React.DOM.header(null, 
	                    React.DOM.h1({className: "article__title"},  this.props.title), 
	                    React.DOM.h3({className: "article__meta"}, "First published ",  this.props.publishedAt)
	                ), 
	                React.DOM.div({className: "article__body", dangerouslySetInnerHTML: { __html: this.props.content}}), 
	                React.DOM.hr({className: "rule"}), 
	                React.DOM.p({className: "smallprint"}, "©",  new Date().getFullYear(), " Ian Thomas")
	            )
	        )
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: 'exports',
	    buildLink: function(post) {
	        return '/' + post.year + '/' + post.month + '/' + post.slug +'/';
	    },

	    render: function() {
	        var items = this.props.posts.slice(0, 4);
	        var links = items.map(function(post) {
	            return React.DOM.li(null, React.DOM.a({href: this.buildLink(post)}, post.title))
	        }, this);
